...
public abstract class AbstractSerialThread
{
    ...
    //Length of the message to send to serial
    private int len;
    ...
    public object[] ReadMessage()
    {
        ...
        int len = inputQueue.Count;
        object[] response = inputQueue.ToArray();
    ...
    // ------------------------------------------------------------------------
    public void SendMessage(object message, int varLen)
    {
        len = varLen;
    ...
    public void RunForever()
    {
        ...
        try
        {
            ...
            {
                SendToWire(outputQueue.Dequeue(), serialPort, len);
            }
    ...
    // ------------------------------------------------------------------------
    protected abstract void SendToWire(object message, SerialPort serialPort, int len);
